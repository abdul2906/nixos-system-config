...
_G.packer_plugins = {
  ...
  breezy = {
    loaded = true,
    path = "/home/t/.local/share/nvim/site/pack/packer/start/breezy",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/t/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["vim-nix"] = {
    loaded = true,
    path = "/home/t/.local/share/nvim/site/pack/packer/start/vim-nix",
